...
export const tools: ToolMeta[] = [
  ...
  },
  {
    ...
    description: "Create a free static QR code for a link, text, Wi-Fi, or contact card — no expiry.",
    icon: QrCode,
    category: "Data & Text",
    popular: true,
  },
  {
    ...
    description: "Scan a QR code with your camera or from an image, and read what it contains.",
    icon: ScanQrCode,
    category: "Data & Text",
    popular: true,
  },
...
export const kits: KitMeta[] = [
  {
    ...
    description:
      "Optimize your photo and signature, size files for upload, and pack every document your next job application needs.",
    icon: Briefcase,
  ...
  },
  {
    ...
    description:
      "Create invoices and application packs, calculate GPA, and preview Markdown — document creation in one place.",
    icon: FileText,
    accent: "from-violet-500/20 via-violet-500/5 to-transparent",
    iconClass: "bg-violet-500/15 text-violet-600 dark:text-violet-400",
  },
